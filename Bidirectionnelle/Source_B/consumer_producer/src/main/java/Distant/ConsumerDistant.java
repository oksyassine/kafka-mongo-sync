 ...
 *
 */
public class ConsumerDistant extends Thread {
	public static Document consumer_distant=new Document();
	@Override
	public void run() {
   ...
   Properties properties = new Properties();
    ...
    properties.put(ConsumerConfig.GROUP_ID_CONFIG, "consumer-1-group");
    ...
    //subscribe to topic
    consumer.subscribe(Collections.singleton("ardouz-1"));
    ConnectionString conx = new ConnectionString("mongodb://ip adresse db a distance");
    ...
    while (true) {
        ...
        for (ConsumerRecord<String, String> record : records) {
        	...
        	System.out.println("Message received to distant consumer: "+"topic :" +record.topic().toString() + record.value());
        	...
        	consumer_distant=ne.getFullDocument();
        	
     	//performing the requested operation 
        	if(op.matches("insert")) {
        		if((Distant.ProducerDistant.producer_distant.equals(consumer_distant)))
